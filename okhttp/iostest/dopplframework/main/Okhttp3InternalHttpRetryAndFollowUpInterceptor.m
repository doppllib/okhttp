...
- (Okhttp3Response *)interceptWithOkhttp3Interceptor_Chain:(id<Okhttp3Interceptor_Chain>)chain {
  ...
  while (true) {
    ...
    @catch (Okhttp3InternalConnectionRouteException *e) {
      if (!Okhttp3InternalHttpRetryAndFollowUpInterceptor_recoverWithJavaIoIOException_withBoolean_withOkhttp3Request_(self, [((Okhttp3InternalConnectionRouteException *) nil_chk(e)) getLastConnectException], true, request)) @throw [e getLastConnectException];
      releaseConnection = false;
      continue;
    }
