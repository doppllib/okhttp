...
void Okhttp3InternalFramedSpdy3_Reader_readRstStreamWithOkhttp3InternalFramedFrameReader_Handler_withInt_withInt_(Okhttp3InternalFramedSpdy3_Reader *self, id<Okhttp3InternalFramedFrameReader_Handler> handler, jint flags, jint length) {
  if (length != 8) @throw Okhttp3InternalFramedSpdy3_Reader_ioExceptionWithNSString_withNSObjectArray_(@"TYPE_RST_STREAM length: %d != 8", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(length) } count:1 type:NSObject_class_()]);
  ...
  if (errorCode == nil) {
    @throw Okhttp3InternalFramedSpdy3_Reader_ioExceptionWithNSString_withNSObjectArray_(@"TYPE_RST_STREAM unexpected error code: %d", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(errorCodeInt) } count:1 type:NSObject_class_()]);
  }
...
void Okhttp3InternalFramedSpdy3_Reader_readWindowUpdateWithOkhttp3InternalFramedFrameReader_Handler_withInt_withInt_(Okhttp3InternalFramedSpdy3_Reader *self, id<Okhttp3InternalFramedFrameReader_Handler> handler, jint flags, jint length) {
  if (length != 8) @throw Okhttp3InternalFramedSpdy3_Reader_ioExceptionWithNSString_withNSObjectArray_(@"TYPE_WINDOW_UPDATE length: %d != 8", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(length) } count:1 type:NSObject_class_()]);
  jint w1 = [((id<OkioBufferedSource>) nil_chk(self->source_)) readInt];
  jint w2 = [self->source_ readInt];
  jint streamId = w1 & (jint) 0x7fffffff;
  jlong increment = w2 & (jint) 0x7fffffff;
  if (increment == 0) @throw Okhttp3InternalFramedSpdy3_Reader_ioExceptionWithNSString_withNSObjectArray_(@"windowSizeIncrement was 0", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangLong_valueOfWithLong_(increment) } count:1 type:NSObject_class_()]);
...
void Okhttp3InternalFramedSpdy3_Reader_readPingWithOkhttp3InternalFramedFrameReader_Handler_withInt_withInt_(Okhttp3InternalFramedSpdy3_Reader *self, id<Okhttp3InternalFramedFrameReader_Handler> handler, jint flags, jint length) {
  if (length != 4) @throw Okhttp3InternalFramedSpdy3_Reader_ioExceptionWithNSString_withNSObjectArray_(@"TYPE_PING length: %d != 4", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(length) } count:1 type:NSObject_class_()]);
...
void Okhttp3InternalFramedSpdy3_Reader_readGoAwayWithOkhttp3InternalFramedFrameReader_Handler_withInt_withInt_(Okhttp3InternalFramedSpdy3_Reader *self, id<Okhttp3InternalFramedFrameReader_Handler> handler, jint flags, jint length) {
  if (length != 8) @throw Okhttp3InternalFramedSpdy3_Reader_ioExceptionWithNSString_withNSObjectArray_(@"TYPE_GOAWAY length: %d != 8", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(length) } count:1 type:NSObject_class_()]);
  ...
  if (errorCode == nil) {
    @throw Okhttp3InternalFramedSpdy3_Reader_ioExceptionWithNSString_withNSObjectArray_(@"TYPE_GOAWAY unexpected error code: %d", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(errorCodeInt) } count:1 type:NSObject_class_()]);
  }
...
void Okhttp3InternalFramedSpdy3_Reader_readSettingsWithOkhttp3InternalFramedFrameReader_Handler_withInt_withInt_(Okhttp3InternalFramedSpdy3_Reader *self, id<Okhttp3InternalFramedFrameReader_Handler> handler, jint flags, jint length) {
  ...
  if (length != 4 + 8 * numberOfEntries) {
    @throw Okhttp3InternalFramedSpdy3_Reader_ioExceptionWithNSString_withNSObjectArray_(@"TYPE_SETTINGS length: %d != 4 + 8 * %d", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(length), JavaLangInteger_valueOfWithInt_(numberOfEntries) } count:2 type:NSObject_class_()]);
  }
