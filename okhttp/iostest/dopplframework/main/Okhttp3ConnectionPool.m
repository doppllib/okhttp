...
jint Okhttp3ConnectionPool_pruneAndGetAllocationCountWithOkhttp3InternalConnectionRealConnection_withLong_(Okhttp3ConnectionPool *self, Okhttp3InternalConnectionRealConnection *connection, jlong now) {
  ...
  for (jint i = 0; i < [((id<JavaUtilList>) nil_chk(references)) size]; ) {
    ...
    [((Okhttp3InternalPlatformPlatform *) nil_chk(Okhttp3InternalPlatformPlatform_get())) logWithInt:Okhttp3InternalPlatformPlatform_WARN withNSString:JreStrcat("$@$", @"A connection to ", [((Okhttp3Address *) nil_chk([((Okhttp3Route *) nil_chk([connection route])) address])) url], @" was leaked. Did you forget to close a response body?") withNSException:nil];
