...
jint Okhttp3InternalFramedHttp2_lengthWithoutPaddingWithInt_withByte_withShort_(jint length, jbyte flags, jshort padding) {
  ...
  if (padding > length) {
    @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"PROTOCOL_ERROR padding %s > remaining length %s", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangShort_valueOfWithShort_(padding), JavaLangInteger_valueOfWithInt_(length) } count:2 type:NSObject_class_()]);
  }
...
- (void)readConnectionPreface {
  ...
  if (![JreLoadStatic(Okhttp3InternalFramedHttp2, CONNECTION_PREFACE) isEqual:connectionPreface]) {
    @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"Expected a connection header but was %s", [IOSObjectArray arrayWithObjects:(id[]){ [((OkioByteString *) nil_chk(connectionPreface)) utf8] } count:1 type:NSObject_class_()]);
  }
}
...
- (jboolean)nextFrameWithOkhttp3InternalFramedFrameReader_Handler:(id<Okhttp3InternalFramedFrameReader_Handler>)handler {
  ...
  if (length < 0 || length > Okhttp3InternalFramedHttp2_INITIAL_MAX_FRAME_SIZE) {
    @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"FRAME_SIZE_ERROR: %s", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(length) } count:1 type:NSObject_class_()]);
  }
...
void Okhttp3InternalFramedHttp2_Reader_readHeadersWithOkhttp3InternalFramedFrameReader_Handler_withInt_withByte_withInt_(Okhttp3InternalFramedHttp2_Reader *self, id<Okhttp3InternalFramedFrameReader_Handler> handler, jint length, jbyte flags, jint streamId) {
  if (streamId == 0) @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"PROTOCOL_ERROR: TYPE_HEADERS streamId == 0", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
...
void Okhttp3InternalFramedHttp2_Reader_readDataWithOkhttp3InternalFramedFrameReader_Handler_withInt_withByte_withInt_(Okhttp3InternalFramedHttp2_Reader *self, id<Okhttp3InternalFramedFrameReader_Handler> handler, jint length, jbyte flags, jint streamId) {
  ...
  if (gzipped) {
    @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"PROTOCOL_ERROR: FLAG_COMPRESSED without SETTINGS_COMPRESS_DATA", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
  }
  jshort padding = (flags & Okhttp3InternalFramedHttp2_FLAG_PADDED) != 0 ? (jshort) ([((id<OkioBufferedSource>) nil_chk(self->source_)) readByte] & (jint) 0xff) : 0;
  length = Okhttp3InternalFramedHttp2_lengthWithoutPaddingWithInt_withByte_withShort_(length, flags, padding);
...
void Okhttp3InternalFramedHttp2_Reader_readPriorityWithOkhttp3InternalFramedFrameReader_Handler_withInt_withByte_withInt_(Okhttp3InternalFramedHttp2_Reader *self, id<Okhttp3InternalFramedFrameReader_Handler> handler, jint length, jbyte flags, jint streamId) {
  if (length != 5) @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"TYPE_PRIORITY length: %d != 5", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(length) } count:1 type:NSObject_class_()]);
  if (streamId == 0) @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"TYPE_PRIORITY streamId == 0", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
  Okhttp3InternalFramedHttp2_Reader_readPriorityWithOkhttp3InternalFramedFrameReader_Handler_withInt_(self, handler, streamId);
}
...
void Okhttp3InternalFramedHttp2_Reader_readRstStreamWithOkhttp3InternalFramedFrameReader_Handler_withInt_withByte_withInt_(Okhttp3InternalFramedHttp2_Reader *self, id<Okhttp3InternalFramedFrameReader_Handler> handler, jint length, jbyte flags, jint streamId) {
  if (length != 4) @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"TYPE_RST_STREAM length: %d != 4", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(length) } count:1 type:NSObject_class_()]);
  if (streamId == 0) @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"TYPE_RST_STREAM streamId == 0", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
  ...
  if (errorCode == nil) {
    @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"TYPE_RST_STREAM unexpected error code: %d", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(errorCodeInt) } count:1 type:NSObject_class_()]);
  }
...
void Okhttp3InternalFramedHttp2_Reader_readSettingsWithOkhttp3InternalFramedFrameReader_Handler_withInt_withByte_withInt_(Okhttp3InternalFramedHttp2_Reader *self, id<Okhttp3InternalFramedFrameReader_Handler> handler, jint length, jbyte flags, jint streamId) {
  if (streamId != 0) @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"TYPE_SETTINGS streamId != 0", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
  if ((flags & Okhttp3InternalFramedHttp2_FLAG_ACK) != 0) {
    if (length != 0) @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"FRAME_SIZE_ERROR ack frame should be empty!", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
    [((id<Okhttp3InternalFramedFrameReader_Handler>) nil_chk(handler)) ackSettings];
    return;
  }
  if (length % 6 != 0) @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"TYPE_SETTINGS length %% 6 != 0: %s", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(length) } count:1 type:NSObject_class_()]);
  ...
  for (jint i = 0; i < length; i += 6) {
    ...
    switch (id_) {
      ...
      case 2:
      if (value != 0 && value != 1) {
        @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"PROTOCOL_ERROR SETTINGS_ENABLE_PUSH != 0 or 1", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
      }
      break;
      case 3:
      id_ = 4;
      ...
      id_ = 7;
      if (value < 0) {
        @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"PROTOCOL_ERROR SETTINGS_INITIAL_WINDOW_SIZE > 2^31 - 1", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
      }
      break;
      case 5:
      if (value < Okhttp3InternalFramedHttp2_INITIAL_MAX_FRAME_SIZE || value > 16777215) {
        @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"PROTOCOL_ERROR SETTINGS_MAX_FRAME_SIZE: %s", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(value) } count:1 type:NSObject_class_()]);
      }
      break;
      case 6:
      break;
...
void Okhttp3InternalFramedHttp2_Reader_readPushPromiseWithOkhttp3InternalFramedFrameReader_Handler_withInt_withByte_withInt_(Okhttp3InternalFramedHttp2_Reader *self, id<Okhttp3InternalFramedFrameReader_Handler> handler, jint length, jbyte flags, jint streamId) {
  if (streamId == 0) {
    @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"PROTOCOL_ERROR: TYPE_PUSH_PROMISE streamId == 0", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
  }
  jshort padding = (flags & Okhttp3InternalFramedHttp2_FLAG_PADDED) != 0 ? (jshort) ([((id<OkioBufferedSource>) nil_chk(self->source_)) readByte] & (jint) 0xff) : 0;
...
void Okhttp3InternalFramedHttp2_Reader_readPingWithOkhttp3InternalFramedFrameReader_Handler_withInt_withByte_withInt_(Okhttp3InternalFramedHttp2_Reader *self, id<Okhttp3InternalFramedFrameReader_Handler> handler, jint length, jbyte flags, jint streamId) {
  if (length != 8) @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"TYPE_PING length != 8: %s", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(length) } count:1 type:NSObject_class_()]);
  if (streamId != 0) @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"TYPE_PING streamId != 0", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
...
void Okhttp3InternalFramedHttp2_Reader_readGoAwayWithOkhttp3InternalFramedFrameReader_Handler_withInt_withByte_withInt_(Okhttp3InternalFramedHttp2_Reader *self, id<Okhttp3InternalFramedFrameReader_Handler> handler, jint length, jbyte flags, jint streamId) {
  if (length < 8) @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"TYPE_GOAWAY length < 8: %s", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(length) } count:1 type:NSObject_class_()]);
  if (streamId != 0) @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"TYPE_GOAWAY streamId != 0", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
  ...
  Okhttp3InternalFramedErrorCode *errorCode = Okhttp3InternalFramedErrorCode_fromHttp2WithInt_(errorCodeInt);
  if (errorCode == nil) {
    @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"TYPE_GOAWAY unexpected error code: %d", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(errorCodeInt) } count:1 type:NSObject_class_()]);
  }
...
void Okhttp3InternalFramedHttp2_Reader_readWindowUpdateWithOkhttp3InternalFramedFrameReader_Handler_withInt_withByte_withInt_(Okhttp3InternalFramedHttp2_Reader *self, id<Okhttp3InternalFramedFrameReader_Handler> handler, jint length, jbyte flags, jint streamId) {
  if (length != 4) @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"TYPE_WINDOW_UPDATE length !=4: %s", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(length) } count:1 type:NSObject_class_()]);
  jlong increment = ([((id<OkioBufferedSource>) nil_chk(self->source_)) readInt] & (jlong) 0x7fffffffLL);
  if (increment == 0) @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"windowSizeIncrement was 0", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangLong_valueOfWithLong_(increment) } count:1 type:NSObject_class_()]);
...
withOkhttp3InternalFramedErrorCode:(Okhttp3InternalFramedErrorCode *)errorCode
  ...
  @synchronized(self) {
    if (closed_) @throw create_JavaIoIOException_initWithNSString_(@"closed");
    if (((Okhttp3InternalFramedErrorCode *) nil_chk(errorCode))->httpCode_ == -1) @throw Okhttp3InternalFramedHttp2_illegalArgumentWithNSString_withNSObjectArray_(@"errorCode.httpCode == -1", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
...
- (void)windowUpdateWithInt:(jint)streamId
  ...
  @synchronized(self) {
    ...
    if (windowSizeIncrement == 0 || windowSizeIncrement > (jlong) 0x7fffffffLL) {
      @throw Okhttp3InternalFramedHttp2_illegalArgumentWithNSString_withNSObjectArray_(@"windowSizeIncrement == 0 || windowSizeIncrement > 0x7fffffffL: %s", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangLong_valueOfWithLong_(windowSizeIncrement) } count:1 type:NSObject_class_()]);
    }
    jint length = 4;
...
- (void)frameHeaderWithInt:(jint)streamId
  ...
  if (length > maxFrameSize_) {
    @throw Okhttp3InternalFramedHttp2_illegalArgumentWithNSString_withNSObjectArray_(@"FRAME_SIZE_ERROR length > %d: %d", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(maxFrameSize_), JavaLangInteger_valueOfWithInt_(length) } count:2 type:NSObject_class_()]);
  }
  if ((streamId & -0x7fffffff - 1) != 0) @throw Okhttp3InternalFramedHttp2_illegalArgumentWithNSString_withNSObjectArray_(@"reserved bit set: %s", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_(streamId) } count:1 type:NSObject_class_()]);
...
void Okhttp3InternalFramedHttp2_ContinuationSource_readContinuationHeader(Okhttp3InternalFramedHttp2_ContinuationSource *self) {
  ...
  if (type != Okhttp3InternalFramedHttp2_TYPE_CONTINUATION) @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"%s != TYPE_CONTINUATION", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangByte_valueOfWithByte_(type) } count:1 type:NSObject_class_()]);
  if (self->streamId_ != previousStreamId) @throw Okhttp3InternalFramedHttp2_ioExceptionWithNSString_withNSObjectArray_(@"TYPE_CONTINUATION streamId changed", [IOSObjectArray arrayWithLength:0 type:NSObject_class_()]);
}
