...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[7].selector = @selector(proxy);
  methods[8].selector = @selector(proxySelector);
  methods[9].selector = @selector(cookieJar);
  methods[10].selector = @selector(cache);
  methods[11].selector = @selector(internalCache);
  methods[12].selector = @selector(dns);
  methods[13].selector = @selector(socketFactory);
  methods[14].selector = @selector(sslSocketFactory);
  methods[15].selector = @selector(hostnameVerifier);
  methods[16].selector = @selector(certificatePinner);
  methods[17].selector = @selector(authenticator);
  methods[18].selector = @selector(proxyAuthenticator);
  methods[19].selector = @selector(connectionPool);
  methods[20].selector = @selector(followSslRedirects);
  methods[21].selector = @selector(followRedirects);
  methods[22].selector = @selector(retryOnConnectionFailure);
  methods[23].selector = @selector(dispatcher);
  methods[24].selector = @selector(protocols);
  methods[25].selector = @selector(connectionSpecs);
  methods[26].selector = @selector(interceptors);
  methods[27].selector = @selector(networkInterceptors);
  methods[28].selector = @selector(newCallWithOkhttp3Request:);
  methods[29].selector = @selector(newBuilder);
  #pragma clang diagnostic pop
  static const J2ObjcFieldInfo fields[] = {
    { "DEFAULT_PROTOCOLS", "LJavaUtilList;", .constantValue.asLong = 0, 0x1a, -1, 8, 9, -1 },
    { "DEFAULT_CONNECTION_SPECS", "LJavaUtilList;", .constantValue.asLong = 0, 0x1a, -1, 10, 11, -1 },
    ...
    { "protocols_", "LJavaUtilList;", .constantValue.asLong = 0, 0x10, -1, -1, 9, -1 },
    { "connectionSpecs_", "LJavaUtilList;", .constantValue.asLong = 0, 0x10, -1, -1, 11, -1 },
    { "interceptors_", "LJavaUtilList;", .constantValue.asLong = 0, 0x10, -1, -1, 12, -1 },
    { "networkInterceptors_", "LJavaUtilList;", .constantValue.asLong = 0, 0x10, -1, -1, 12, -1 },
  ...
  static const void *ptrTable[] = { "LOkhttp3OkHttpClient_Builder;", "systemDefaultSslSocketFactory", "LJavaxNetSslX509TrustManager;", "()Ljava/util/List<Lokhttp3/Protocol;>;", "()Ljava/util/List<Lokhttp3/ConnectionSpec;>;", "()Ljava/util/List<Lokhttp3/Interceptor;>;", "newCall", "LOkhttp3Request;", &Okhttp3OkHttpClient_DEFAULT_PROTOCOLS, "Ljava/util/List<Lokhttp3/Protocol;>;", &Okhttp3OkHttpClient_DEFAULT_CONNECTION_SPECS, "Ljava/util/List<Lokhttp3/ConnectionSpec;>;", "Ljava/util/List<Lokhttp3/Interceptor;>;" };
  static const J2ObjcClassInfo _Okhttp3OkHttpClient = { "OkHttpClient", "okhttp3", ptrTable, methods, fields, 7, 0x1, 30, 27, -1, 0, -1, -1, -1 };
...
id<JavaxNetSslX509TrustManager> Okhttp3OkHttpClient_systemDefaultTrustManager(Okhttp3OkHttpClient *self) {
  @try {
    NSString *defaultAlgorithm = JavaxNetSslTrustManagerFactory_getDefaultAlgorithm();
    AndroidUtilLog_wWithNSString_withNSString_([Okhttp3OkHttpClient_class_() getSimpleName], JreStrcat("$$", @"defaultAlgorithm: ", defaultAlgorithm));
    JavaxNetSslTrustManagerFactory *trustManagerFactory = JavaxNetSslTrustManagerFactory_getInstanceWithNSString_(defaultAlgorithm);
    AndroidUtilLog_wWithNSString_withNSString_([Okhttp3OkHttpClient_class_() getSimpleName], @"after");
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LOkhttp3OkHttpClient_Builder;", 0x1, 26, 27, -1, -1, -1, -1 },
    { NULL, "LOkhttp3OkHttpClient_Builder;", 0x1, 28, 27, -1, -1, -1, -1 },
    { NULL, "LOkhttp3OkHttpClient_Builder;", 0x1, 29, 30, -1, -1, -1, -1 },
    { NULL, "LOkhttp3OkHttpClient_Builder;", 0x1, 31, 32, -1, -1, -1, -1 },
    { NULL, "LOkhttp3OkHttpClient_Builder;", 0x1, 33, 32, -1, -1, -1, -1 },
    { NULL, "LOkhttp3OkHttpClient_Builder;", 0x1, 34, 32, -1, -1, -1, -1 },
    { NULL, "LOkhttp3OkHttpClient_Builder;", 0x1, 35, 36, -1, -1, -1, -1 },
    { NULL, "LOkhttp3OkHttpClient_Builder;", 0x1, 37, 38, -1, 39, -1, -1 },
    { NULL, "LOkhttp3OkHttpClient_Builder;", 0x1, 40, 38, -1, 41, -1, -1 },
    { NULL, "LJavaUtilList;", 0x1, -1, -1, -1, 42, -1, -1 },
    { NULL, "LOkhttp3OkHttpClient_Builder;", 0x1, 43, 44, -1, -1, -1, -1 },
    { NULL, "LJavaUtilList;", 0x1, -1, -1, -1, 42, -1, -1 },
    { NULL, "LOkhttp3OkHttpClient_Builder;", 0x1, 45, 44, -1, -1, -1, -1 },
  ...
  methods[15].selector = @selector(certificatePinnerWithOkhttp3CertificatePinner:);
  methods[16].selector = @selector(authenticatorWithOkhttp3Authenticator:);
  methods[17].selector = @selector(proxyAuthenticatorWithOkhttp3Authenticator:);
  methods[18].selector = @selector(connectionPoolWithOkhttp3ConnectionPool:);
  methods[19].selector = @selector(followSslRedirectsWithBoolean:);
  methods[20].selector = @selector(followRedirectsWithBoolean:);
  methods[21].selector = @selector(retryOnConnectionFailureWithBoolean:);
  methods[22].selector = @selector(dispatcherWithOkhttp3Dispatcher:);
  methods[23].selector = @selector(protocolsWithJavaUtilList:);
  methods[24].selector = @selector(connectionSpecsWithJavaUtilList:);
  methods[25].selector = @selector(interceptors);
  methods[26].selector = @selector(addInterceptorWithOkhttp3Interceptor:);
  methods[27].selector = @selector(networkInterceptors);
  methods[28].selector = @selector(addNetworkInterceptorWithOkhttp3Interceptor:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "protocols_", "LJavaUtilList;", .constantValue.asLong = 0, 0x0, -1, -1, 46, -1 },
    { "connectionSpecs_", "LJavaUtilList;", .constantValue.asLong = 0, 0x0, -1, -1, 47, -1 },
    { "interceptors_", "LJavaUtilList;", .constantValue.asLong = 0, 0x10, -1, -1, 48, -1 },
    { "networkInterceptors_", "LJavaUtilList;", .constantValue.asLong = 0, 0x10, -1, -1, 48, -1 },
  ...
  static const J2ObjcClassInfo _Okhttp3OkHttpClient_Builder = { "Builder", "okhttp3", ptrTable, methods, fields, 7, 0x19, 30, 25, 0, -1, -1, -1, -1 };
