...
Okhttp3InternalFramedFramedStream *Okhttp3InternalFramedFramedConnection_newStreamWithInt_withJavaUtilList_withBoolean_withBoolean_(Okhttp3InternalFramedFramedConnection *self, jint associatedStreamId, id<JavaUtilList> requestHeaders, jboolean outArg, jboolean inArg) {
  ...
  @synchronized(self->frameWriter_) {
    @synchronized(self) {
      ...
      self->nextStreamId_ += 2;
      stream = create_Okhttp3InternalFramedFramedStream_initWithInt_withOkhttp3InternalFramedFramedConnection_withBoolean_withBoolean_withJavaUtilList_(streamId, self, outFinished, inFinished, requestHeaders);
...
void Okhttp3InternalFramedFramedConnection_closeWithOkhttp3InternalFramedErrorCode_withOkhttp3InternalFramedErrorCode_(Okhttp3InternalFramedFramedConnection *self, Okhttp3InternalFramedErrorCode *connectionCode, Okhttp3InternalFramedErrorCode *streamCode) {
  ...
  @synchronized(self) {
    if (![((id<JavaUtilMap>) nil_chk(self->streams_)) isEmpty]) {
      streamsToClose = [((id<JavaUtilCollection>) nil_chk([self->streams_ values])) toArrayWithNSObjectArray:[IOSObjectArray arrayWithLength:[self->streams_ size] type:Okhttp3InternalFramedFramedStream_class_()]];
      [self->streams_ clear];
    }
    if (self->pings_ != nil) {
      pingsToCancel = [((id<JavaUtilCollection>) nil_chk([self->pings_ values])) toArrayWithNSObjectArray:[IOSObjectArray arrayWithLength:[((id<JavaUtilMap>) nil_chk(self->pings_)) size] type:Okhttp3InternalFramedPing_class_()]];
  ...
  @synchronized(this$0_) {
    ...
    if (peerInitialWindowSize != -1 && peerInitialWindowSize != priorWriteWindowSize) {
      ...
      if (![((id<JavaUtilMap>) nil_chk(this$0_->streams_)) isEmpty]) {
        streamsToNotify = [((id<JavaUtilCollection>) nil_chk([this$0_->streams_ values])) toArrayWithNSObjectArray:[IOSObjectArray arrayWithLength:[this$0_->streams_ size] type:Okhttp3InternalFramedFramedStream_class_()]];
      }
    }
...
withOkhttp3InternalFramedErrorCode:(Okhttp3InternalFramedErrorCode *)errorCode
  ...
  @synchronized(this$0_) {
    streamsCopy = [((id<JavaUtilCollection>) nil_chk([((id<JavaUtilMap>) nil_chk(this$0_->streams_)) values])) toArrayWithNSObjectArray:[IOSObjectArray arrayWithLength:[this$0_->streams_ size] type:Okhttp3InternalFramedFramedStream_class_()]];
...
- (void)execute {
  ...
  @catch (JavaIoIOException *e) {
    [((Okhttp3InternalPlatformPlatform *) nil_chk(Okhttp3InternalPlatformPlatform_get())) logWithInt:Okhttp3InternalPlatformPlatform_INFO withNSString:JreStrcat("$$", @"FramedConnection.Listener failure for ", this$0_->this$0_->hostname_) withNSException:e];
    @try {
