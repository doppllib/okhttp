...
- (void)execute {
  ...
  @catch (JavaIoIOException *e) {
    if (signalledCallback) {
      [((Okhttp3InternalPlatformPlatform *) nil_chk(Okhttp3InternalPlatformPlatform_get())) logWithInt:Okhttp3InternalPlatformPlatform_INFO withNSString:JreStrcat("$$", @"Callback failure for ", Okhttp3RealCall_toLoggableString(this$0_)) withNSException:e];
    }
    else {
